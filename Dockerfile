...
USER lime
ENTRYPOINT ["/bin/sh", "-c", "./manage.py makemigrations && ./manage.py migrate && gunicorn bot_project.wsgi:application -b 0.0.0.0:8000 --timeout 10 --workers 2 --preload --capture-output --log-level debug"]
